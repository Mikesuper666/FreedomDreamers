...
public class LivroIntroCopia extends Entidade{
         ...
         */
        public LivroIntroCopia(int hp, int atk, int x, int y, int startingAlpha){
        ...
        public void tick(){
            ...
            // Hover
            if (tick >= 0 && tick <= 30){
                super.y -= HUDManager.getSpeed(NucleoManager.altura, 1080);
            }
